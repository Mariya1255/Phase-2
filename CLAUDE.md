...
## Project Requirements and Agent Assignments
...
### Agent Assignments
- **Authentication:** Use Auth Agent for user signup/signin and JWT token management
- **Frontend Development:** Use Frontend Agent for Next.js application development
- **Database Design and Operations:** Use DB Agent for Neon Serverless PostgreSQL
- **Backend Development:** Use Backend Agent for FastAPI RESTful API endpoints
